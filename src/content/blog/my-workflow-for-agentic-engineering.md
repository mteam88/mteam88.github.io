...
- Blast radius: If you are compromised in any way (including leaking private keys to an AI), move all funds immediately. Use a hardware wallet instead of a browser wallet for any significant \$\$ amounts.
